        ...
        <?php } else { ?>
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <div class="result-print">
                                <?php
                                    $res=new mysqli('localhost','root','','testsystem');
                                    
                                    $nam=$_COOKIE['user'];
                                    $res->query("INSERT INTO `itog`(`quest`,`itog`,`nam`)
                                    VALUES('$testTitle','$result','$nam')");
                                    echo $result;
                                    if ($_COOKIE['user']=='ivan'):{
                                        $res->query("INSERT INTO `itog_ivan`(`quest`,`itog`,`nam`)
                                        VALUES('$testTitle','$result','$nam')");
                                    }
                                    elseif ($_COOKIE['user']=='karina'):{
                                        $res->query("INSERT INTO `itog_karina`(`quest`,`itog`,`nam`)
                                        VALUES('$testTitle','$result','$nam')");
                                    }
                                    elseif ($_COOKIE['user']=='nika'):{
                                        $res->query("INSERT INTO `itog_nika`(`quest`,`itog`,`nam`)
                                        VALUES('$testTitle','$result','$nam')");
                                    }
                                    elseif ($_COOKIE['user']=='ivan'):{
                                        $res->query("INSERT INTO `itog_`(`quest`,`itog`,`nam`)
                                        VALUES('$testTitle','$result','$nam')");
                                    }
                    ...
                    $questionCount = $row['count'];
                    ?>
                    <a href="/admin/oprosi.php"><button type="button" class="btn btn-success">выйти</button></a>
                </div>
            </div>
        <?php } ?>
    </div>
